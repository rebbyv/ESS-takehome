  ...
  return (
    <div className='test-row'>
      ...
      <span className='test-box edit-box'>
        <span className='edit-course-btn' onClick={() => props.edit(props.data, 'Course')}>Edit Course</span>
        {props.data.name !== null ? <span className='edit-test-btn' onClick={() => props.edit(props.data, 'Test')}>Edit Test</span>: null}
        <span className='edit-course-btn' onClick={() => props.add('Test', props.data.courseID)}>Add Test</span>
      </span>
    </div>
  )
}
